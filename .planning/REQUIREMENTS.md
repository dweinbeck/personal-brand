...
- [ ] **ASST-01**: Assistant chat uses external FastAPI RAG service (chatbot-assistant on Cloud Run) instead of internal Gemini backend
- [ ] **ASST-02**: Next.js API route proxies to FastAPI server-to-server (no CORS, no browser-to-backend direct connection)
...
|-------------|-------|--------|
| ASST-01 | Phase 13 | Pending |
| ASST-02 | Phase 13 | Pending |
