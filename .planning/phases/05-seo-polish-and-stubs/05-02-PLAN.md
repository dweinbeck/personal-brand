...
<task type="auto">
  ...
  <action>
    ...
    5. If any score is below 90, examine the audit details to identify specific failures and fix them. Limit fixes to at most 4 files (listed above: layout.tsx, page.tsx, HeroSection.tsx, ProjectCard.tsx). If more files need changes, document the remaining issues in the summary for a follow-up plan. Common fixes:
