...
<task type="checkpoint:human-action" gate="blocking">
  ...
  <action>
    ...
    **Step B: Create Stripe webhook endpoint (to get whsec_ signing secret)**
    ...
    > **Note:** The webhook endpoint will return 404 responses until Phase 24 deployment completes. This is expected — Stripe automatically retries failed deliveries for up to 3 days, and the endpoint will start succeeding once the app is deployed.
...
<task type="checkpoint:human-action" gate="blocking">
  ...
  <action>
    ...
    **If any variable is missing or incorrect:** Click "Edit" on the Cloud Build trigger, scroll to "Substitution variables", add or update the variable with the correct value, and click "Save".
