...
export function HeroSection() {
  return (
    <section className="py-16 md:py-24 motion-safe:animate-fade-in-up">
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="mt-6 flex flex-wrap justify-center md:justify-start gap-3">
            {/* Primary CTA: View Projects (internal Link) */}
            <Link
              href="/projects"
            ...
            {/* Secondary CTA: Contact (internal Link) */}
            <Link
              href="/contact"
            ...
            {/* GitHub icon button (external anchor) */}
            <a
            ...
            {/* LinkedIn icon button (external anchor) */}
            <a
