export const metadata = {
  title: "Creating a Functional Requirements Document (FRD)",
...
- [FRD Generator](https://dev.dan-weinbeck.com/tools/frd-generator) — generate a structured FRD from your specs
