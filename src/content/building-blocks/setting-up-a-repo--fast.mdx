Want the quick way? Here's a Claude Code command you can save that will initialize a new repo from within your project folder — all in one command.
...
The manual approach teaches you the fundamentals — essential knowledge for any developer. But once you understand how git and GitHub work, this command saves you from typing the same 6-8 commands every time you start a new project.

Switch to the **Fundamentals** tab if you want to understand what's happening under the hood.
